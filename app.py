...
def index():
    ...
    if request.method == 'POST':
        ...
        pred_value = np.round(pred_value[0],2)*1.08
        company = company
        ram = ram
        typename= typename
        opsys= opsys
    ...
    return render_template('home.html', pred_value=pred_value, company=company,ram=ram,typename=typename,opsys=opsys,cpu=cpu,gpu=gpu)
